    ...
    public class ScrollSynchronizer : DependencyObject
    {
        ...
        private static void OnScrollGroupChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (d is ListView)
            {
                ...
                lv.Loaded += (o, s) =>
                {
                    var vp = ((VirtualizingStackPanel)typeof(ItemsControl).InvokeMember("_itemsHost", BindingFlags.Instance | BindingFlags.GetField | BindingFlags.NonPublic, null, lv, null));
                    OnScrollGroupChanged(vp.ScrollOwner, e);
                };
            }
